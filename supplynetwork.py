...
class SupplyNetwork:
    ...
    Attributes:
        ...
        arcs: dict of Arc objects, key by a two-tuple of node_name names (source, target)
    ...
    def __init__(self, nodes: List[Node], arcs: List[Arc], agent_managed_facilities: List[str], policies=None):
        ...
        self.order_sequence = graph.parse_action_sequence([node for node in self.nodes], self.customers_dict)
