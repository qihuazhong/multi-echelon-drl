...
from envs import InventoryManagementEnvMultiPlayer, make_beer_game, make_beer_game_normal_multi_facility, make_beer_game_uniform_multi_facility
...
class TestBuildBeerGame(unittest.TestCase):
    ...
    def test_classic_beer_game_gym_compatibility(self):
        ...
        check_env(make_beer_game(agent_managed_facilities=['retailer', 'wholesaler', 'distributor', 'manufacturer']))

    def test_uniform_beer_game_gym_compatibility(self):
        check_env(make_beer_game_uniform_multi_facility(agent_managed_facilities=['retailer'], box_action_space=True))
        check_env(make_beer_game_uniform_multi_facility(agent_managed_facilities=['wholesaler'], box_action_space=True))
        check_env(make_beer_game_uniform_multi_facility(agent_managed_facilities=['retailer', 'wholesaler'], box_action_space=True))
        check_env(make_beer_game_uniform_multi_facility(agent_managed_facilities=['retailer', 'wholesaler', 'distributor', 'manufacturer'], box_action_space=True))

    def test_normal_beer_game_gym_compatibility(self):
        check_env(make_beer_game_normal_multi_facility(agent_managed_facilities=['retailer'], box_action_space=True))
        check_env(make_beer_game_normal_multi_facility(agent_managed_facilities=['wholesaler'], box_action_space=True))
        check_env(make_beer_game_normal_multi_facility(agent_managed_facilities=['retailer', 'wholesaler'], box_action_space=True))
        check_env(make_beer_game_normal_multi_facility(agent_managed_facilities=['retailer', 'wholesaler', 'distributor', 'manufacturer'], box_action_space=True))


# def test_player_indexes(players):
#     beer_game = make_beer_game_normal_multi_facility(players)
#     return beer_game.scn.agent_indexes
